...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run one-day internalization backtest using signal-first matching.")
    ...
    print(f"orderEventCount={len(order_events_df)}")
